...
<body style="background-color: #<?php echo $colores[$c]; ?>;">
      ...
      <div class="flex">
                ...
                <a style="left:120px; height:160px; top:370px; width:160px; background-image:url(<?php bloginfo('template_directory');?>/img/menu-cats/textos.jpg);       background-size:cover;" width="200" height="150"  title="Textos"        href="<?php bloginfo('wpurl');?>?cat=17"> <div class="textos">Textos</div></a>
                <a style="left:285px; height:75px;  top:335px; width:275px; background-image:url(<?php bloginfo('template_directory');?>/img/menu-cats/pizarron.jpg);     background-size:cover;" width="275" height="110" title="Pizarron"      href="<?php bloginfo('wpurl');?>?cat=18"> <div class="textos">pizarrón</div></a>
                <a style="left:575px; height:100px; top:360px; width:185px; background-image:url(<?php bloginfo('template_directory');?>/img/menu-cats/sanValentin.jpg);  background-size:cover;" width="185" height="105" title="San Valentin"  href="<?php bloginfo('wpurl');?>?cat=19"> <div class="textos">san valentín</div></a>
